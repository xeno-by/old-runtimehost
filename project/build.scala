...
object build extends Build {
  lazy val sharedSettings = Defaults.defaultSettings ++ Seq(
    ...
    description := "Runtime reflection host for Project Palladium",
    ...
    logBuffered := false,
    scalaHome := {
      val scalaHome = System.getProperty("runtimehost.scala.home")
      if (scalaHome != null) {
  ...
  lazy val publishableSettings = sharedSettings ++ Seq(
    ...
    pomExtra := (
      <url>https://github.com/scalareflect/runtimehost</url>
      ...
      <scm>
        <url>git://github.com/scalareflect/runtimehost.git</url>
        <connection>scm:git:git://github.com/scalareflect/runtimehost.git</connection>
      </scm>
      <issueManagement>
        <system>GitHub</system>
        <url>https://github.com/scalareflect/runtimehost/issues</url>
      </issueManagement>
    ),
